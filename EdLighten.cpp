//Find "REPLACE" and "REPLACE_END" to replace relevant code.
...
int main(int, char**)
{
    ...
    //REPLACE_END (for initialisation)
...
//REPLACE (for extra helper functions)
// Simple helper function to load an image into a DX11 texture with common settings
//Mainly from Dear ImGui forums
bool LoadTextureFromImaging(imaging::image img, ID3D11ShaderResourceView** out_srv, int* out_width, int* out_height){
...
//REPLACE_end (for extra helper functions)
